...
const config = Object.freeze({
  ...
  GEMINI_BASE_URL: env.GEMINI_BASE_URL || 'https://generativelanguage.googleapis.com/v1/models',
  GEMINI_TIMEOUT: env.GEMINI_TIMEOUT || env.APP_API_TIMEOUT,
  GEMINI_COMPLETION_MODEL: env.GEMINI_COMPLETION_MODEL || 'gemini-pro',
  GEMINI_COMPLETION_TEMPERATURE: Number(env.GEMINI_COMPLETION_TEMPERATURE) || 1,
  GEMINI_COMPLETION_MAX_TOKENS: Number(env.GEMINI_COMPLETION_MAX_TOKENS) || 64,
  GEMINI_VISION_MODEL: env.GEMINI_VISION_MODEL || 'gemini-pro-vision',
});
